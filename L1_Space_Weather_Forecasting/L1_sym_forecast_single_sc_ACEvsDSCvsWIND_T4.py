# -*- coding: utf-8 -*-
"""
Created on Fri Feb  2 12:02:32 2024
...
df_sym = pd.read_csv('SYM4_unix.csv')
...
df_params1 = pd.read_csv('dscovr_T4_1min_unix.csv')
...
# Need to do this again here only for this file weirdly, others must not remove any nans then
DateTime1 = df_params1['DateTime']
...
df_params2 = pd.read_csv('wind_T4_1min_unix.csv')
...
# Read in B field and plasma data for the WIND dataset
df_params3 = pd.read_csv('ace_T4_1min_unix.csv')
...
# Plot forecasted SYM/H in storm to compare to calculated SYM/H
plt.plot(DateTime3[downtoval:uptoval], sym_forecast3[downtoval:uptoval], label='ACE Forecasted SYM/H')
plt.plot(DateTime1[downtoval:uptoval], sym_forecast1[downtoval:uptoval], label='DSCOVR Forecasted SYM/H')
plt.plot(DateTime2[downtoval:uptoval], sym_forecast2[downtoval:uptoval], label='WIND Forecasted SYM/H')
