...
# Use random dataset as test
df1 = pd.read_csv('dscovr_T1_1min_unix.csv')[541280:]
df2 = pd.read_csv('wind_T1_1min_unix.csv')[541280:]
df3 = pd.read_csv('ace_T1_1min_unix.csv')[541280:]
...
E_propagated = weightedAv(slist,array_BSN,8)
P_propagated = weightedAv(slist,array_BSN,7)


#%% Plot results

plt.plot(df1['Time'].values,E_propagated)
plt.plot(df1['Time'].values,P_propagated)
